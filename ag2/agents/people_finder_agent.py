...
from agents.prompts import PERPLEXITY_PEOPLE_FINDER_SYSTEM_MESSAGE
...
class PeopleFinderAgent(ConversableAgent):
    ...
    async def process_message(self, sender: Agent, intakeInfoString: str, companyListString: str) -> str:
        ...
        for company in company_list:
            ...
            # Build a search prompt for this company
            prompt = self._build_people_search_prompt(intake_info, company_info)
            print("--------------------------------Prompt--------------------------------")
    ...
    def _build_people_search_prompt(self, intake_info, company_info):
